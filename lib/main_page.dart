        ...
        builder: (context, value, child) {
          return Container(
            ...
            child: Scaffold(
              ...
              body: Center(
                child: value.horoscope == null || value.error
                          ...
                          Column(
                            children: [
                              Row(
                                ...
                                children: [
                                  DateButton(date: 'Yesterday', onTap: () {
                                    value.setDate('daily-yesterday');
                                  },),
                                  DateButton(date: 'Today', onTap: () {
                                    value.setDate('daily-today');
                                  },),
                                  DateButton(date: 'Tomorrow', onTap: () {
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  DateButton(date: 'Week', onTap: () {
                                    value.setDate('weekly');
                                  },),
                                  DateButton(date: 'Month', onTap: () {
